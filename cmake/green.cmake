...
if (ENABLE_SOLVER_GREEN)
  message(STATUS "Green solver support enabled")
    set(ENABLE_GREEN 1) # For config.h

else()
  message(STATUS "Green solver support disabled")
    set(ENABLE_GREEN 0) # For config.h
endif()
