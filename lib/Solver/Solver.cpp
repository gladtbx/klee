...
ValidatingSolver::computeInitialValues(const Query& query,
  ...
  if (hasSolution) {
    ...
    if (!answer)
      assert(0 && "invalid solver result (computeInitialValues)");    
>>>>>>> Solved (or partially solved, as there is more than one solver implementation and I don't have time to look at all of them) a bug in master version. Detail explaination:
*/  
  }
  llvm::errs() << "]\n";
  llvm::errs() << "Query [\n";
...
/*
<<<<<<< 59f1705cb72b4424ec71fe308e85ef229e44c5ba
=======
